...
Student::Student(const std::string &name, const std::string &surname,
                 ...
                 const Pesel &pesel, Gender gender)
...
void Student::set_gender(Gender) { gender_ = Gender::other; }

void Student::set_name(const std::string &name) { name_ = name; }

void Student::set_surname(const std::string &surname) { surname_ = surname; }

void Student::set_address(const std::string &address) { address_ = address; }

void Student::set_id_number(unsigned int id_number) { id_number_ = id_number; }
void Student::set_pesel(Pesel &pesel) { pesel_ = pesel; }

// Getters implementation
[[nodiscard]] std::string Student::get_name() const { return name_; }

[[nodiscard]] std::string Student::get_surname() const { return surname_; }

[[nodiscard]] std::string Student::get_address() const { return address_; }

[[nodiscard]] unsigned int Student::get_id_number() const { return id_number_; }

[[nodiscard]] Pesel Student::get_pesel() const { return pesel_; }

[[nodiscard]] Gender Student::get_gender() const { return gender_; }
